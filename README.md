...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-htm2txt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11140&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-htm2txt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-htm2txt` can be installed with:

```
conda install r-htm2txt
```

It is possible to list all of the versions of `r-htm2txt` available on your platform with:
